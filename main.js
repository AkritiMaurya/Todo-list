...
//   if (e.keyCode === 13 || (e.keyCode === 0 && e.key === 'Enter')) {
...
function handleInputKeypress(e) {
  // If the key pressed is the Enter key (keyCode 13) or if the key pressed is the Enter button on the addTaskButton
  if (e.keyCode === 13 || (e.keyCode === 0 && e.key === 'Enter')) {
    addTaskFromInput(); // Call the function to add the task
  }
}
...
function initializeTheCode() {
  ...
  //18 add event listener to button for handling click events
